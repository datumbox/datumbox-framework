 ...
 * @param <TP>
 */
public abstract class AbstractTransformer<MP extends AbstractTransformer.ModelParameters, TP extends AbstractTransformer.TrainingParameters> extends AbstractTrainer<MP, TP, DoubleKnowledgeBase<MP, TP>> {
     ...
     */
    protected AbstractTransformer(String dbName, DatabaseConfiguration dbConf, Class<MP> mpClass, Class<TP> tpClass) {
