...
public class StreamMethods {
     ...
     * @return 
     */
    public static <T> Stream<T> stream(Iterable<T> in, boolean parallel) {
        return StreamSupport.<T>stream(in.spliterator(), parallel);
    }
     ...
     * @return 
     */
    public static <T> Stream<T> stream(Iterator<T> in, boolean parallel) {
