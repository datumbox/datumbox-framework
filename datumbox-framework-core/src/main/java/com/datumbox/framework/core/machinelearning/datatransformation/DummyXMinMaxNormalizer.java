...
public class DummyXMinMaxNormalizer extends AbstractDummyMinMaxTransformer<DummyXMinMaxNormalizer.ModelParameters, DummyXMinMaxNormalizer.TrainingParameters> {
     ...
     */
    protected DummyXMinMaxNormalizer(String dbName, Configuration conf, TrainingParameters trainingParameters) {
     ...
     */
    protected DummyXMinMaxNormalizer(String dbName, Configuration conf) {
        super(dbName, conf);
    }
