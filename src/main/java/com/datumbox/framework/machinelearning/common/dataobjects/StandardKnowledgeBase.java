 ...
 * @param <TP>
 */
public class StandardKnowledgeBase<MP extends BaseModelParameters, TP extends BaseTrainingParameters> implements KnowledgeBase<MP, TP> {
     ...
     * @param tpClass 
     */
    public StandardKnowledgeBase(String dbName, DatabaseConfiguration dbConf, Class<MP> mpClass, Class<TP> tpClass) {
        this.dbConf = dbConf;
